...
console.log(`${colors.cyan}Starting X-Seller-8 Multi-Store Inventory Management System...${colors.reset}`);
...
// Start backend server (using our enhanced multi-store version)
const backendServer = startProcess(
  'API',
  'node',
  ['backend/server_enhanced_with_stores.js'],
  { 
    env: {
      ...process.env,
      PORT: API_PORT
...
const server = app.listen(3000, () => {
  console.log(`
${colors.cyan}X-Seller-8 Multi-Store Inventory System is now running!${colors.reset}
...
${colors.yellow}Each store has its own:${colors.reset}
- Inventory data
- Uploaded documents
